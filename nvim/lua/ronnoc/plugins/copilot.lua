...
return { -- Use native snippets from Neovim v0.10
-- {   
--     "nvim-cmp",
...
--             function()
--                 local icon = require("lazy.config").icons.kinds.Copilot
--                 return icon
--             end,
--             cond = function()
...
-- } 
{
    ...
    dependencies = {{"nvim-telescope/telescope.nvim"}, -- Use telescope for help actions
    ...
    event = "VeryLazy",
    keys = { -- Show help actions with telescope
    {
        "<leader>ah",
        function()
